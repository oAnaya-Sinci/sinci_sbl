...
class SpReturnDatosOeeComponentes extends Migration
{
    ...
    IF (_caso = 'd') then    
        select 
            ...
            cast( sum(goodParts)as decimal(5,2)) GoodParts,
            cast( sum(totalPieces)as decimal(5,2)) TotalParts,
            cast( sum(totalPieces) - sum(GoodParts) as decimal(5,2)) BadParts,
            cast( sum(runTime) as decimal(5,2)) RunningTime,
            cast( sum(availableTime) as decimal(5,2)) AvailableTime,
            cast( avg(ICT) as decimal(5,2)) ICT
